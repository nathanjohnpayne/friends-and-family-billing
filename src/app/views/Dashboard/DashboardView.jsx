...
export default function DashboardView() {
    ...
    // #321: owedAdjustments threaded in so active Service Credits lower owed in the
    // settlement metrics (reopen set 5th, owedAdjustments 6th — same order as #319⊕#321).
