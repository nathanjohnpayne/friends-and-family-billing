 ...
 */
export default function SettlementBoard({ familyMembers, bills, payments, creditAdjustments = [], owedAdjustments = [], readOnly, onRecordPayment, onTextInvoice, onEmailInvoice, onGenerateShareLink, onManageShareLinks, onViewHistory, onAddCharge }) {
...
function HouseholdCard({ row, payments, readOnly, onRecordPayment, onTextInvoice, onEmailInvoice, onGenerateShareLink, onManageShareLinks, onViewHistory, onAddCharge }) {
