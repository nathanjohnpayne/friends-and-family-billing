 ...
 * loaded via <script> tag in app/index.html). This keeps firebase-config.local.js
 * as the single source of truth during coexistence with the legacy app.
 *
 * At final cutover, config values move to .env.local and this file reads from
