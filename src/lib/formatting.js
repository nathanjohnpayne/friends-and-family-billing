...
export const PAYMENT_METHOD_ICONS = {
    ...
    check: '<svg viewBox="0 0 100 100" fill="currentColor"><rect width="100" height="100" rx="18"/><path transform="translate(19,19) scale(2.7)" d="M4 10v7h3v-7H4zm6 0v7h3v-7h-3zM2 22h19v-3H2v3zm14-12v7h3v-7h-3zm-4.5-9L2 6v2h19V6l-9.5-5z" fill="var(--color-surface, #fff)"/></svg>',
