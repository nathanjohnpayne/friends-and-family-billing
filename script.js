        ...
        return `
            <div class="bill-item" data-bill-id="${bill.id}">
                ...
                <div class="bill-actions">
                    ...
                    ${archived ? '' : `<div class="bill-actions-dropdown">
...
const PAYMENT_METHOD_ICONS = {
    ...
    apple_cash: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.71 19.5C17.88 20.74 17 21.95 15.66 21.97C14.32 22 13.89 21.18 12.37 21.18C10.84 21.18 10.37 21.95 9.1 22C7.79 22.05 6.8 20.68 5.96 19.47C4.25 16.99 2.97 12.5 4.7 9.56C5.55 8.08 7.13 7.16 8.82 7.14C10.1 7.12 11.32 8.01 12.11 8.01C12.91 8.01 14.37 6.94 15.92 7.1C16.57 7.13 18.39 7.36 19.56 9.07C19.47 9.13 17.39 10.33 17.41 12.85C17.44 15.88 20.06 16.88 20.09 16.89C20.06 16.97 19.67 18.34 18.71 19.5ZM13 3.5C13.73 2.67 14.94 2.04 15.94 2C16.07 3.17 15.58 4.35 14.88 5.18C14.19 6.02 13.07 6.69 11.95 6.61C11.8 5.46 12.39 4.26 13 3.5Z"/></svg>',
