...
function updateSummary() {
    ...
    if (enabledMethods.length > 0) {
        const icons = enabledMethods.map(m =>
            '<span class="payment-strip-icon" title="' + escapeHtml(m.label || getPaymentMethodLabel(m.type)) + '">' + getPaymentMethodIcon(m.type) + '</span>'
        ).join('');
...
const PAYMENT_METHOD_ICONS = {
    ...
    apple_cash: '<svg viewBox="0 0 24 24" fill="currentColor"><rect width="24" height="24" rx="4.5" fill="currentColor"/><path d="M15.57 16.26C15.1 17.02 14.57 17.73 13.77 17.74C12.97 17.76 12.72 17.26 11.81 17.26C10.89 17.26 10.62 17.73 9.86 17.76C9.07 17.79 8.47 16.95 7.97 16.21C6.97 14.69 6.21 11.93 7.24 10.13C7.75 9.23 8.69 8.67 9.71 8.66C10.47 8.64 11.2 9.19 11.67 9.19C12.15 9.19 13.02 8.54 13.95 8.64C14.34 8.65 15.43 8.79 16.13 9.84C16.08 9.87 14.84 10.6 14.85 12.15C14.87 14C16.44 14.61 16.46 14.62 16.44 14.67C16.21 15.51 15.57 16.26 15.57 16.26ZM12.65 6.36C13.09 5.85 13.81 5.46 14.41 5.44C14.49 6.15 14.19 6.87 13.77 7.38C13.36 7.89 12.69 8.3 12.02 8.25C11.93 7.55 12.28 6.82 12.65 6.36Z" fill="var(--color-surface, #fff)"/></svg>',
